...
def render_markdown(
    ...
    if narration:
        ...
        # verbatim from the gate; this paragraph is a model's explanation of it
        # and has the gate's vocabulary stripped, so the two can never be
        ...
        lines.append("")
        lines.append(
            "<sub>Explanation generated by watsonx.ai. The verdict above is not "
            "— it comes from the deterministic gate.</sub>"
        )
        lines.append("")
